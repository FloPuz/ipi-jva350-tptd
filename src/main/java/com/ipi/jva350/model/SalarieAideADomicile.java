...
public class SalarieAideADomicile {
    ...
    /**
     * D'apr�s https://femme-de-menage.ooreka.fr/comprendre/conges-payes-femme-de-menage :
     * Pour s'ouvrir des droits � cong�s pay�s – capitalisation de jours + prise et/ou paiement – l'aide m�nag�re doit avoir travaill� pour le particulier employeur :
     *     pendant au moins dix jours (pas forc�ment de suite) ;
     *     � l'int�rieur d'une p�riode de temps – dite de « r�f�rence » – allant du 1er juin de l'ann�e N au 31 mai de l'ann�e N + 1.
     * @return
     */
